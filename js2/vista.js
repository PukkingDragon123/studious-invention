...
const Vista = (() => {
  ...
  function pit(act) {
    ...
    const K = act === 5 ? { g: ['#1f1b26', '#2e2b38', '#3b3648', '#4d4a5c', '#6e6b80'], s: ['#4d4a5c', '#6e6b80', '#9391a6'], t: ['#e06a1b', '#ffa832'] }
      : act === 4 ? { g: ['#8498c0', '#98acd0', '#aec0e0', '#c4d4ee', '#dae6f8'], s: ['#4d4a5c', '#6e6b80', '#9391a6'], t: ['#ffffff', '#e8f0ff'] }
        : act === 3 ? { g: ['#8a522e', '#a0623a', '#b87646', '#cc8a52', '#dca060'], s: ['#e8dfc6', '#c4b89a', '#8a7f68'], t: ['#9a9a4a', '#b8b25a'] }
