...
kept with the art sources), so the whole cast shares a set of proportions and a
way of being drawn: flat colour with a single shadow tone that follows the
silhouette, a rim light down the near edge, chunky rounded limbs with the far
arm and leg a tone back for depth, heavy angular brows, big hair masses, and fur
with a ragged zigzag hem. Changing a proportion changes everyone at once.
